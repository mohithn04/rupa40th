  ...
  ({ title, name, bgColor, textColor, img, children }) => {
    ...
    return <>
      <li className="w-[853px] min-h-[420px] list-none flex mt-10 max-sm:w-[300px]  max-sm:flex-col max-sm:min-h-[420px] " style={{ backgroundColor: bgColor }}>
        ...
        <div className="w-6/12 font-sofia flex items-center justify-evenly flex-col max-sm:flex-col" style={{ color: textColor }}>
          ...
          <p className="w-4/5 text-right text-[14px] font-bold pt-5 max-sm:w-6/12 max-sm:text-[14px] max-sm:p-2">{name}</p>
        </div>
